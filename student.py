...
class Student:
    def __init__(self,root):
        ...
        ###3rd  image ===
        img2=Image.open("college_images/s1.jpg")
        ...
        #title
        title_lbl=Label(bg_img_lbl,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="red",fg="white")
        ...
        current_frame.place(x=5,y=135,width=720,height=115)
        
        #Department====
        dep_lbl=Label(current_frame,text="Department",font=("times new roman",12,"bold"),bg="white")
        dep_lbl.grid(row=0,column=0,padx=3,sticky=W)
        ...
        #Course====
        course_lbl=Label(current_frame,text="course",font=("times new roman",12,"bold"),bg="white")
        course_lbl.grid(row=0,column=2,padx=10,sticky=W)
        
        course_combo=ttk.Combobox(current_frame,textvariable=self.var_course,font=("times new roman",12,"bold"),width=20,state="readonly")
        course_combo["values"]=("Select course","FE","PP","TT","DK")
        ...
        year_combo=ttk.Combobox(current_frame,textvariable=self.var_year,font=("times new roman",12,"bold"),width=20,state="readonly")
        ...
        semester_combo=ttk.Combobox(current_frame,textvariable=self.var_semester,font=("times new roman",12,"bold"),width=20,state="readonly")
        ...
        student_id_lbl=Label(class_student_frame,text="Student ID",font=("times new roman",12,"bold"))
        ...
        student_name_lbl=Label(class_student_frame,text="Student name",font=("times new roman",12,"bold"))
        ...
        phones_lbl=Label(class_student_frame,text="Phones",font=("times new roman",12,"bold"))
        phones_lbl.grid(row=3,column=2,padx=10,pady=5,sticky=W)
        
        phones_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",13,"bold"))
        phones_entry.grid(row=3,column=3,padx=10,pady=5,sticky=W)
        ...
        teacher_lbl=Label(class_student_frame,text="Teacher",font=("times new roman",12,"bold"))
        ...
        img_right=Image.open("college_images/har.jpg")
        ...
        search_student_frame.place(x=5,y=135,width=640,height=70)
        
        search_lbl=Label(search_student_frame,text="Search By",font=("times new roman",15,"bold"),bg="red",fg="white")
        ...
        search_entry=ttk.Entry(search_student_frame,width=13,font=("times new roman",13,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)
        
        search_btn=Button(search_student_frame,text="Search",width=10,font=("times new roman",13,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=4,padx=4)
        
        showall_btn=Button(search_student_frame,text="Show All",width=10,font=("times new roman",13,"bold"),bg="blue",fg="white")
        showall_btn.grid(row=0,column=3,padx=4)
        
        #table frame===
        table_student_frame=Frame(right_frame,bd=2,relief=RIDGE)
        table_student_frame.place(x=5,y=210,width=635,height=350)
        
        scroll_x=ttk.Scrollbar(table_student_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_student_frame,orient=VERTICAL)
        
        self.student_table=ttk.Treeview(table_student_frame,columns=("dep","course","year","sem","id","name","roll","gender","div","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="admin123",database="face_recognition")
                    my_curser=conn.cursor()
                    my_curser.execute("update student set Dep=%s,course=%s,year=%s,name=%s,Semester=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                            self.var_dep.get(),
                            self.var_course.get(),
                            self.var_year.get(),
                            self.var_semester.get(),
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Student Delete","Do you really want to delete",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="admin123",database="face_recognition")
                    my_curser=conn.cursor()
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #========load frontal face by face frontal by open cv2
